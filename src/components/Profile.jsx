    ...
    <div id="profile">
     <div className='container-fluid  p-5  '>
         ...
         <Fade left>
             ...
             <img  src="photo.png" className="img-thumbnail rounded-circle" alt="mypic"/>
             </div>
             </Fade>
             <Fade right>
             <div className="col-md-6  my-5 py-5">
               <h1 className='text text-center font-weight-bold'>Hello, I am Shubham👋</h1>
               <div>
                 <p className='text text-center  my-5 h3'>
                 💻Full-Stack web developer with a degree in Master of Computer Application who believes in sharing knowledge, 
