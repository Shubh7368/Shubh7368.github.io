            ...
            <div className="col-xl-6 py-4 ">
              <div className={styles.footer_image}>
                ...
                <div>
                  ...
                  <h2 className="text  "> <a href="tel:9309972686" className="text-reset text-decoration-none">9309972686</a></h2>
                </div>
              </div>
            </div>
            <div className="col-xl-6 py-4 ">
              ...
              <div className={styles.footer_maindiv}>
                <Slide right>
                  ...
                  <div>
                    <a href="mailto:adhaneshubham622@gmail.com?subject=subject&cc=adhaneshubham622@gmail.com" target="_blank">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="46"
                        height="46"
